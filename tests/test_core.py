...
from pixelrelay.providers.base import GenerationResult
from pixelrelay.exceptions import AllProvidersFailedError, ProviderUnavailableError
...
async def test_generate_uses_first_provider():
    with patch("pixelrelay.core._build_provider") as mock_build:
...
async def test_fallback_on_provider_unavailable():
    ...
    with patch("pixelrelay.core._build_provider", side_effect=build_side_effect):
        with patch("pixelrelay.core._cooldown") as mock_cooldown:
